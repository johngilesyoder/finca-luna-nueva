...
function footer_menu_1() {
  ...
  wp_nav_menu(array('theme_location' => $location, 'items_wrap' => '<h4>' . esc_html($menu_obj->name) . '</h4><ul id="footer-menu-1" class="footer-menu">%3$s</ul>'));
}
...
function footer_menu_2() {
  ...
  get_menu_by_location($location);
  $menu_obj = get_menu_by_location($location);
  wp_nav_menu(array('theme_location' => $location, 'items_wrap' => '<h4>' . esc_html($menu_obj->name) . '</h4><ul id="footer-menu-2" class="footer-menu">%3$s</ul>'));
}
...
function footer_menu_3() {
  ...
  get_menu_by_location($location);
  $menu_obj = get_menu_by_location($location);
  wp_nav_menu(array('theme_location' => $location, 'items_wrap' => '<h4>' . esc_html($menu_obj->name) . '</h4><ul id="footer-menu-3" class="footer-menu">%3$s</ul>'));
}
...
function footer_menu_4() {
  ...
  get_menu_by_location($location);
  $menu_obj = get_menu_by_location($location);
  wp_nav_menu(array('theme_location' => $location, 'items_wrap' => '<h4>' . esc_html($menu_obj->name) . '</h4><ul id="footer-menu-4" class="footer-menu">%3$s</ul>'));
}
...
function html5blank_header_scripts() {
  if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
    ...
    wp_register_script('html5blankscripts', get_template_directory_uri() . '/assets/js/min/scripts-min.js', array('jquery'), '1.1.2'); // Custom scripts
...
function html5blank_conditional_scripts() {
  if (is_front_page()) {
    ...
    wp_register_script('home', get_template_directory_uri() . '/assets/js/sections/min/home-min.js', array(), '1.1.3', true); // Home scripts
  ...
  if (is_page('reservations')) {
    ...
    wp_register_script('reservations', get_template_directory_uri() . '/assets/js/sections/min/reservations-min.js', array(), null, true); // Home scripts
    wp_enqueue_script('reservations'); // Enqueue it!
...
function html5blank_styles() {
  ...
  wp_register_style('google-fonts', 'https://fonts.googleapis.com/css?family=Crimson+Text:400,400italic,600italic,600|Julius+Sans+One', array(), '1.0', 'all');
...
function register_html5_menu() {
  register_nav_menus(array( // Using array to specify more menus if needed
    ...
    'footer-menu-2'           => __('Footer Menu 2', 'secondary'),
    'footer-menu-3'           => __('Footer Menu 3', 'secondary'),
    'footer-menu-4'           => __('Footer Menu 4', 'secondary'),
  ));
}
